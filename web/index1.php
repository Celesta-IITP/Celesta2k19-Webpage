...
<head>
  ...
  <title>Celesta'19 IIT-Patna</title>
  <meta name="description"
    content="The McBride Company is a concept and design firm that creates branded entertainment and hospitality experiences around the world." />
  <link rel="canonical" href="https://mcbridedesign.com/" />
    ...
    <span class="logo-wrapper js-logo">
      <a href="/" class="c-logo">
        ...
        <div class="c-logo__txt">
          <span>Celesta</span><span>: A Stellar Trek</span>
        </div>
      </a>
    ...
    <div class="nav-container">
      <nav class="main-nav">
        <ul>
          ...
          <li><a class="main-nav__link tx--title-3" href="https://mcbridedesign.com/careers" title="Careers">Careers</a></li>
        </ul>
      </nav>
    ...
    <div class="barba-container" data-namespace="prism">
      <div class="home-wrapper">
        <div class="landing-brands js-brands">
          <div class="brand brand-1" data-brand="Think" data-js-item="1"
            ...
            <div aria-hidden class="word-content tx--gray-blue-1">
              ...
              <a href="/projects" class="btn btn--dark btn--hollow">Discover</a>
            </div>
          </div>
          ...
          <div class="brand brand-3" data-brand="Brand" data-js-item="3"
            ...
            <div aria-hidden class="word-content tx--gray-blue-1">
              <p class="tx--body-lead">
                Brand Beta specializes in the creation of brand identities,
                graphic nomenclature, brand language, and visual content.
              </p>
              <a href="/projects" class="btn btn--dark btn--hollow">Discover</a>
            </div>
          </div>
        ...
        <ul class="viewport-links">
          <li class="left ">
            <a href="https://mcbridedesign.com/company" title="Who We Are" class="tx--caption">Who We Are</a>
          </li>

          <li class="bottom mobile-hide">
            <a href="/news" title="News &amp; Press" class="tx--caption">News &amp; Press</a>
          </li>

          <li class="right mobile-hide">
            <a href="https://mcbridedesign.com/connect" title="Get In Touch" class="tx--caption">Get In Touch</a>
          </li>
        </ul>
      </div>
    </div>
