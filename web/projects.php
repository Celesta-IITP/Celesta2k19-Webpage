...
<!-- Mirrored from mcbridedesign.com/projects by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2019 12:01:38 GMT -->
<!-- Added by HTTrack -->
...
<head>
  ...
  <title>Projects - The McBride Company</title>
...
<body>
  ...
  <header class="site--header js-header">
    ...
    <a href="./projects.html" class="projects-btn o-media__icon tx--gray-light">
    ...
    <div class="nav-container">
      <nav class="main-nav">
        <ul>
          ...
          <li>
            <a class="main-nav__link tx--title-3 active" href="projects.html" title="Projects">Projects</a>
          </li>

          <li>
            <a class="main-nav__link tx--title-3" href="company.html" title="Who We Are">Who We Are</a>
          </li>

          <li>
            <a class="main-nav__link tx--title-3" href="connect.html" title="Connect">Connect</a>
          </li>
      ...
      <nav class="more-nav">
        ...
        <ul class="more-nav__list">
          ...
          <span>
            <li>
              <a class="no-barba tx--caption first" href="sound-design.html" title="Sound Design" target="_blank">Sound
                Design</a>
            </li>
    ...
    <div class="barba-container js-scrollable-page project-list-page" data-namespace="no-prism">
      <section class="project-list js-scrollable-page">
        ...
        <div class="scrollable">
          <a class="project-link is--available is--active" data-js-index="1" href="work/hospitality.html"
            atl="Hospitality">
            <article class="project"
              data-img-lg="assets/images/work/Hollywood-Beach-Resort-Flip-Flop-Sculpture-Hollywood-FL.jpg"
              data-img-md="assets/images/work/Hollywood-Beach-Resort-Flip-Flop-Sculpture-Hollywood-FL.jpg"
              data-img-sm="assets/images/work/Hollywood-Beach-Resort-Flip-Flop-Sculpture-Hollywood-FL.jpg">
              <h1 class="project-title tx--title-2">Hospitality</h1>
            </article>
          </a>

          <a class="project-link is--available " data-js-index="2" href="work/restaurants.html" atl="Restaurants">
            <article class="project" data-img-lg="assets/images/home/ESCARDA-0582F-color-enhance.jpg"
              data-img-md="assets/images/home/ESCARDA-0582F-color-enhance.jpg"
              data-img-sm="assets/images/home/ESCARDA-0582F-color-enhance.jpg">
              <h1 class="project-title tx--title-2">Restaurants</h1>
            </article>
          </a>

          <a class="project-link is--available " data-js-index="3" href="work/retail.html" atl="Retail">
            <article class="project" data-img-lg="assets/images/work/Citiplace-Square.jpg"
              data-img-md="assets/images/work/Citiplace-Square.jpg"
              data-img-sm="assets/images/work/Citiplace-Square.jpg">
              <h1 class="project-title tx--title-2">Retail</h1>
            </article>
          </a>

          <a class="project-link is--available " data-js-index="4" href="work/entertainment.html" atl="Entertainment">
            <article class="project" data-img-lg="assets/images/work/Famil-Entertainment-Center-Colorado-Springa-CO.jpg"
              data-img-md="assets/images/work/Famil-Entertainment-Center-Colorado-Springa-CO.jpg"
              data-img-sm="assets/images/work/Famil-Entertainment-Center-Colorado-Springa-CO.jpg">
              <h1 class="project-title tx--title-2">Entertainment</h1>
            </article>
          </a>

          <a class="project-link is--available " data-js-index="5" href="work/signage-and-graphics.html"
            atl="Signage and Graphics">
            <article class="project" data-img-lg="assets/images/work/Margaritaville-Billboard.jpg"
              data-img-md="assets/images/work/Margaritaville-Billboard.jpg"
              data-img-sm="assets/images/work/Margaritaville-Billboard.jpg">
              <h1 class="project-title tx--title-2">Signage and Graphics</h1>
            </article>
          </a>
        </div>

        <picture class="project-image poly-2">
          <img src="assets/images/work/Hollywood-Beach-Resort-Flip-Flop-Sculpture-Hollywood-FL.jpg"
            title="Hollywood Beach Resort Flip Flop Sculpture Hollywood Fl" />
        </picture>

        <div class="no-projects-alert">
          <div class="tx--title-2">No Projects Available</div>
        </div>
      </section>
    </div>
  </main>
...
<!-- Mirrored from mcbridedesign.com/projects by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2019 12:01:47 GMT -->
