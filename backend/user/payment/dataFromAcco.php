...
<body>
	<form method="POST" name="customerData" action="ccavRequestHandler.php">
		...
		<table width="50%" height="100" border='1' align="center">
			...
			<tr>
				<td>Redirect URL :</td>
				<td><input type="text" name="redirect_url" value="http://www.techprolabz.com/pay/ccavResponseHandlerAcco.php" readonly />
				</td>
			</tr>
			<tr>
				<td>Cancel URL :</td>
				<!-- http://www.techprolabz.com/pay/ccavResponseHandlerAcco.php -->
				<td><input type="text" name="cancel_url" value="http://www.techprolabz.com/pay/ccavResponseHandlerAcco.php" readonly/>
				</td>
			</tr>
			<tr>
				<td>Language :</td>
				...
				<td colspan="2">
					<div id="emi_div" style="display: none">
						<table border="1" width="100%">
							...
							<tr>
								<td> Emi plan id: </td>
								<td><input readonly="readonly" type="text" id="emi_plan_id" name="emi_plan_id"
										value="" /> </td>
							</tr>
							<tr>
								<td> Emi tenure id: </td>
								<td><input readonly="readonly" type="text" id="emi_tenure_id" name="emi_tenure_id"
										value="" /> </td>
							</tr>
							<tr>
								<td>Pay Through</td>
			...
			<tr>
				<td> Promotions:</td>
				<td> <select name="promo_code" id="promo_code">
